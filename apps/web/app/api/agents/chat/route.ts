    ...
    const agents = [
      {
        id: 'hermes',
        name: 'Hermes',
        description: 'Account Manager Assistant for DOPE Marketing. Helps account managers with account management tasks using specialized tools.',
        capabilities: ['account-management', 'client-data-lookup', 'proposal-guidance', 'knowledge-search', 'email-templates', 'transcripts', 'faq-search', 'web-search'],
        tools: [
          'web_search',
      ...
      },
      {
        id: 'steve',
        name: 'Steve',
        description: 'Leadership Agent for DOPE Marketing. Leverages CliftonStrengths and employee profiles to enhance team collaboration, facilitate standup meetings, support training and onboarding, assist with performance improvement plans, and develop strategic rollout documents.',
        capabilities: ['standup-facilitation', 'team-collaboration', 'team-development', 'training-support', 'onboarding-assistance', 'performance-improvement', 'strategic-planning', 'clifton-strengths'],
        tools: [
          'web_search',
          'facilitate_standup',
          'pinecone_company_knowledge_semantic_search', 
      ...
      },
      {
        id: 'dope-admin',
        name: 'Dope Admin',
        description: 'Dope Marketing Admin Agent. Helps the engineer complete any tasks. Has access to Pinecone knowledge base tools for managing indexes and performing semantic searches.',
        capabilities: ['admin-support', 'knowledge-base-management', 'index-management', 'data-indexing', 'semantic-search', 'web-search'],
        tools: [
          'web_search',
