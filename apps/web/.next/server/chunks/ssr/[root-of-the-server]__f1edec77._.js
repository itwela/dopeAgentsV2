...
const AgentChatProvider = ({ children, userId })=>{
    ...
    const loadThreads = async (userId)=>{
        if (!userId) return;
        try {
            const userThreads = await convex.query(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].threads.getUserThreads, {
                userId
            });
    ...
    const selectThread = async (threadId)=>{
        try {
            const thread = await convex.query(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].threads.getThread, {
                threadId
            });
            if (thread) {
    ...
    const deleteThread = async (threadId)=>{
        try {
            await convex.mutation(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].threads.deleteThread, {
                threadId
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f1edec77._.js.map