...
"[project]/apps/web/convex/_generated/api.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/convex/_generated/api.js [app-client] (ecmascript)");
;
...
const AgentChatProvider = (param)=>{
    ...
    const loadThreads = async (userId)=>{
        if (!userId) return;
        try {
            const userThreads = await convex.query(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].threads.getUserThreads, {
                userId
            });
    ...
    const selectThread = async (threadId)=>{
        try {
            const thread = await convex.query(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].threads.getThread, {
                threadId
            });
            if (thread) {
    ...
    const deleteThread = async (threadId)=>{
        try {
            await convex.mutation(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].threads.deleteThread, {
                threadId
            });
...
//# sourceMappingURL=apps_web_8972ebd1._.js.map