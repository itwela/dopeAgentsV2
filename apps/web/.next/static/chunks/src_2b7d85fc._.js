...
function SignInPage() {
    ...
    const handleSubmit = async (event)=>{
        ...
        setIsLoading(true);
        console.log("".concat(step === "signIn" ? "Signing in" : "Signing up", "..."));
        try {
            ...
            console.log("".concat(step === "signIn" ? "Signed in" : "Account created", " successfully!"));
        } catch (error) {
            console.error("Error ".concat(step === "signIn" ? "signing in" : "signing up", ":"), error);
        } finally{
            setIsLoading(false);
...
_s(SignInPage, "Ebyhqsj18gRqNcv5vy5KfmktCIA=", false, function() {
    return [
...
//# sourceMappingURL=src_2b7d85fc._.js.map